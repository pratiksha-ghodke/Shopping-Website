...
if(isset($_POST['add_product']))
{
    ...
    $select_product_name = mysqli_query($conn,"SELECT name FROM `products` WHERE name = '$name'") or die('query falied');
    ...
    if(mysqli_num_rows($select_product_name)>0)
    {
        ...
        if($add_product_query){
            ...
            $message[]='product colud not be added!';
        }
    }
}
...
<section class="show-products">
        <div class="box-container">
            ...
            ?>
            <div class="box">
                <img src="uploaded_img/<?php echo $fetch_products['image'];?>" alt="" height="200" width="200">
...
<section class="edit-product-form">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <img src="uploaded_img/<?php echo $fetch_update['image'];?>" alt="" height="200" width="200">
        <input type="text" name="update_name" value="<?php echo $fetch_update['name'];?>" class="box" required placeholder="Enter product name">
        <input type="number" name="update_price" value="<?php echo $fetch_update['price'];?>" min="0" class="box" required placeholder="Enter product price">
        <input type="file" class="box" name="update_image" accept="image/jpg,image/jpeg,image/png">
        <input type="submit" value="update" name="update_product" class="btn">
        <input type="reset" value="cancle" id="close-update" class="option-btn">
    </form>
    <?php
              }
            }
